...
- After any modification in this repo, commit and push immediately once the smallest relevant verification passes.
- Do not install or run full builds unless explicitly requested.
